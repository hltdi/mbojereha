...
#                    print("Inserting tag {} for token {}".format(newtag, token))
    ...
    def morph_anal(self, tagged=None):
        ...
        Use POS disambiguator if appropriate.
        """
        analyses = []
        for index, tok in enumerate(self.toks):
            ...
            tokpre = tok.prefix
            tokname = tok.name
            # Don't skip numeral words, like "dos"
            if (tok.special and tokpre[1:] != 'N') or tok.punc or not tokstring:
                ...
                if anals:
                    ...
                    if cached_anal:
                        ...
                        analyses.append([tokstring, self.language.anal_word(tokname, check_cache=False,
                                                                            clean=False)])
        return analyses
